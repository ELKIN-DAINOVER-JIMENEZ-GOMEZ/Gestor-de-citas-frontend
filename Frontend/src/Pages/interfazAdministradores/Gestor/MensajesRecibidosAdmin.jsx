                    ...
                    <div className="flex-1">
                      <div className="flex items-center space-x-3 mb-2">
                        ...
                        <span className="px-2 py-1 bg-gray-100 text-gray-800 rounded-full text-xs font-medium">
                          {tiposMensajeLabels[mensaje.tipoMensaje]}
                        </span>
                      </div>
            ...
            <div className="bg-white rounded-lg p-6 max-w-2xl w-full max-h-screen overflow-y-auto">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  <span className={`px-2 py-1 rounded-full text-xs font-medium ${prioridadColors[mensajeSeleccionado.prioridad]}`}>
                    {mensajeSeleccionado.prioridad}
                  </span>
                  <span className="px-2 py-1 bg-gray-100 text-gray-800 rounded-full text-xs font-medium">
                    {tiposMensajeLabels[mensajeSeleccionado.tipoMensaje]}
                  </span>
...
export default MensajesRecibidosAdmin;